...
class ExploreActivity : BottomNavigationActivity() {

  override fun onCreate(savedInstanceState: Bundle?) {
    super.onCreate(savedInstanceState)

    val searchView: SearchView = findViewById(R.id.exp_search)
    searchView.setOnSearchClickListener {
      // Handle search view click listener
    }

    val spinner1: Spinner = findViewById(R.id.exp_spinner1)
    ...
    val spinner2: Spinner = findViewById(R.id.exp_spinner2)
    ...
    val spinner3: Spinner = findViewById(R.id.exp_spinner3)
...
class ExploreActivity : AppCompatActivity()
{
 override fun onCreate(savedInstanceState: Bundle?)
 {
   ...
   BottomNavigationActivity() {
     ...
     override fun onCreate(savedInstanceState: Bundle?) {
       super.onCreate(savedInstanceState)
       // No need to set content view here, it will be handled by BottomNavigationActivity
     }
